...
@section('title','الموصلون')
@section('breadcrumb','الموصلون')
@section('styles')
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase">بيانات الموصلون</span>
        </div>
        <div class="tools"> </div>
      </div>
        ...
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              ...
              <table class="table table-striped table-bordered table-hover table-header-fixed" id="drivers">
                <thead>
                  <th class="col-md-1">أسم المستخدم</th>
                  <th class="col-md-1">أسم العرض</th>
                  <th class="col-md-1">صورة المستخدم</th>
