...
@section('title','احجام الواجبات')
@section('breadcrumb','احجام الواجبات')
@section('content')
  <!-- Main content -->
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="portlet light bordered">
        <div class="portlet-title">
          <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">بيانات احجام الواجبات</span>
          </div>
          <div class="tools"> </div>
        </div>
        <div class="portlet-body">
          ...
          <table class="table table-striped table-bordered table-hover table-header-fixed" id="meals">
            <thead>
            <th class="col-md-1">حجم الوجبة</th>
