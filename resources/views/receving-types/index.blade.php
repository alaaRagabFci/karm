...
@section('title','أليات استلام الطلبات')
@section('breadcrumb','أليات استلام الطلبات')
@section('styles')
@endsection
@section('content')
<!-- Main content -->
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark">
          ...
          <span class="caption-subject bold uppercase">بيانات أليات استلام الطلبات</span>
        </div>
        <div class="tools"> </div>
      </div>
